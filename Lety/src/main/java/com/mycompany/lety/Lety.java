...
import java.io.BufferedReader;//clase para leer el texto del archivo csv
import java.io.BufferedWriter;//clase para escribir en el archivo csv
import java.io.FileReader;//Leer en un fichero
import java.io.FileWriter;//Escribir en un fichero
import java.io.PrintWriter;//Librería para imprimir los datos del archivo csv
...
public class Lety {//inicio de la clase principal
    ...
    public void guardarArchivo(GatosDatos data){
        try{
            FileWriter fw=new FileWriter("Gatos.csv",true);
            BufferedWriter bw=new BufferedWriter(fw);
            PrintWriter pw=new PrintWriter(bw);
            //pw.println("Nombre"+","+"Color"+","+"Raza"+","+"Sexo"+","+"Edad");//Para mostrar el encabezado en el archivocsv
    ...
    public DefaultTableModel ListaGenerada(){
        ...
        try{
            FileReader fw=new FileReader("Gatos.csv");
